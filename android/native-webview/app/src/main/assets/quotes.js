/**
 * База абсурдных ретро-цитат проекта «Шизо 95»
 * Полностью автономная оффлайн-база без внешних сетевых запросов.
 */
const SHIZO_QUOTES = [
  {
    "id": 1,
  ...
  },
  {
    "id": 6,
    "category": "Псевдолатынь и античность",
    "text": "In vino veritas, in cydere blue screen of death."
  },
  {
    "id": 7,
  ...
  },
  {
    "id": 12,
    "category": "IT-деградация и деплой",
    "text": "Кэш DNS пропах жареной рыбой. Не перезагружайте шлюз до полнолуния."
  },
  {
    "id": 13,
  ...
  },
  {
    "id": 16,
    "category": "Бытовой сюрреализм и локальные новости",
    "text": "В третьем подъезде обнаружен портал в 1997 год. Жильцы жалуются на звуки модемного дозвона и запах варёной сгущёнки."
  },
  {
    "id": 17,
    "category": "Бытовой сюрреализм и локальные новости",
    "text": "Пенсионерка нашла в мешке картошки второе сознание и отказалась платить за него по тарифу ЖКХ."
  },
  {
    "id": 18,
  ...
  },
  {
    "id": 22,
    "category": "Миннесотский диалект и неожиданные иноязычные вставки",
    "text": "Uff da! The snow is up to the gutters, but the lutefisk won't soak itself, ya heard?"
  }
];

// Также сохраняем JSON копию для fetch-совместимости
if (typeof module !== "undefined" && module.exports) {
  module.exports = SHIZO_QUOTES;
}
